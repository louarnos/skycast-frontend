...
/***/ function(module, exports, __webpack_require__) {
	...
	var authEvents = __webpack_require__(137);
	...
	var addHandlers = function addHandlers() {
	  ...
	  $('#jumbotron-btn').on('click', function (event) {
	    ...
	    getPosition().then(function (position) {
	      ...
	      appApi.getLocalForecast(appUi.getForecastSuccess, appUi.getForecastFailure, position);
	    }).catch(function (err) {
	  ...
	  $('#location-search-btn').on('click', function (event) {
	    ...
	    var input = $('#location-search-input').val();
	    input = input.replace(/ /g, "+");

	    //GET FORECAST
	    appApi.getNonLocalForecast(appUi.getForecastSuccess, appUi.getForecastFailure, { input: input });
	  });
	  ...
	  $(document).on('click', '.multiple-results-list', function (event) {
	    ...
	    app.results.forEach(function (place) {
	      if (id === place.formatted_address) {
	        ...
	        appApi.getLocalForecast(appUi.getForecastSuccess, appUi.getForecastFailure, { coords: coords });
	      }
	    });
	  });
	  ...
	  $(document).on('click', '.historical-multiple-results-list', function (event) {
	    ...
	    app.results.forEach(function (place) {
	      if (id === place.formatted_address) {
	        ...
	        appApi.getHistoricalData(appUi.getHistoricalDataSuccess, appUi.getHistoricalDataFailure, data);
	      }
	    });
	  });
	  ...
	  $('#historical-location-search-btn').on('click', function (event) {
	    ...
	    //COLLECTS USER INPUT
	    var startDate = new Date($('#forecast-start-date').val());
	    var endDate = new Date($('#forecast-end-date').val());
	    app.query = $('#historical-location-search-input').val();
	    var input = $('#historical-location-search-input').val();
	    input = input.replace(/ /g, "+");
...
/***/ function(module, exports) {
	...
	var app = {
	  api: 'https://vast-mesa-49693.herokuapp.com'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getLocalForecast = function getLocalForecast(success, failure, data) {
	  $.ajax({
	    method: 'POST',
	...
	var getNonLocalForecast = function getNonLocalForecast(success, failure, data) {
	  $.ajax({
	    method: 'POST',
	...
	var getHistoricalData = function getHistoricalData(success, failure, data) {
	  $.ajax({
	    method: 'POST',
	...
	var saveQuery = function saveQuery(success, failure, data) {
	  $.ajax({
	    method: 'POST',
	    url: app.api + '/query/',
	    data: data,
	...
	var getQueries = function getQueries(success, failure) {
	  $.ajax({
	    method: 'GET',
	    url: app.api + '/query/',
	    headers: {
	...
	var saveHistoricalQuery = function saveHistoricalQuery(success, failure, data) {
	  $.ajax({
	    method: 'POST',
	...
	module.exports = {
	  ...
	  getNonLocalForecast: getNonLocalForecast,
	  getHistoricalData: getHistoricalData,
	  saveQuery: saveQuery,
	  getQueries: getQueries,
	  saveHistoricalQuery: saveHistoricalQuery
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(4);
	var appApi = __webpack_require__(5);
	var currentWeatherTemp = __webpack_require__(7);
	var forecastTemp = __webpack_require__(27);
	var multipleResultsTemp = __webpack_require__(28);
	var historicalMultipleResultsTemp = __webpack_require__(29);
	var displayQueriesTemp = __webpack_require__(30);
	var displayHistoricalQueriesTemp = __webpack_require__(31);
	var googleCharts = __webpack_require__(32);
	var moment = __webpack_require__(33);

	var getForecastSuccess = function getForecastSuccess(data) {
	  ...
	  if (data.results) {
	    ...
	    $('#multiple-search-results').append(multipleResultsTemp({ result: result }));
	    $('html, body').animate({
	    ...
	    $('#forecast-results').prepend(currentWeatherTemp({ currentWeather: currentWeather }));
	    $('#extended-forecast-results').html('');
	    $('#extended-forecast-results').append(forecastTemp({ forecast: forecast }));
	...
	var getForecastFailure = function getForecastFailure(data) {
	  console.log(data);
	};

	var saveQuerySuccess = function saveQuerySuccess(data) {
	  console.log(data);
	};

	var saveQueryFailure = function saveQueryFailure(data) {
	  console.log(data);
	};

	var getHistoricalDataSuccess = function getHistoricalDataSuccess(data) {
	  console.log(data);
	  ...
	  if (data.locations) {
	    ...
	    var result = data.locations.results;
	    ...
	    $('#multiple-historical-search-results').append(historicalMultipleResultsTemp({ result: result }));
	    $('html, body').animate({
	    ...
	    (function () {
	      ...
	      data.results.forEach(function (query) {
	        appApi.saveQuery(saveQuerySuccess, saveQueryFailure, { 'response': query,
	...
	var getHistoricalDataFailure = function getHistoricalDataFailure(data) {
	  console.log(data);
	};
	...
	var success = function success(data) {
	  ...
	  var historicalQueries = data.filter(function (query) {
	    return Array.isArray(query);
	  });
	  historicalQueries.forEach(function (query) {
	    query = query[0];
	    query.createdAt = moment(query.createdAt).format('LLLL');
	    $('#queries-table > tbody').append(displayHistoricalQueriesTemp({ query: query }));
	  });

	  console.log(historicalQueries);
	  $('#queries-table > tbody').append(displayQueriesTemp({ data: data }));
	};
	...
	module.exports = {
	  getForecastSuccess: getForecastSuccess,
	  getForecastFailure: getForecastFailure,
	  saveQuerySuccess: saveQuerySuccess,
	  saveQueryFailure: saveQueryFailure,
	  getHistoricalDataSuccess: getHistoricalDataSuccess,
	  getHistoricalDataFailure: getHistoricalDataFailure,
	  success: success,
	  failure: failure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"media current-weather-media-object\">\n  <div class=\"media-left\">\n    <a href=\"#\">\n      <img class=\"media-object\" src="
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.currentWeather : depth0)) != null ? stack1.icon : stack1), depth0))
	    + ">\n    </a>\n  </div>\n  <div class=\"media-body\">\n    <h3 class=\"\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.currentWeather : depth0)) != null ? stack1.location : stack1), depth0))
	    + "</h3>\n    <h3 class=\"\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.currentWeather : depth0)) != null ? stack1.time : stack1), depth0))
	    + "</h3>\n    <h4 class=\"media-heading \">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.currentWeather : depth0)) != null ? stack1.temperature : stack1), depth0))
	    + "°</h4>\n    <p class=\"feels-like \">Feels like "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.currentWeather : depth0)) != null ? stack1.apparentTemperature : stack1), depth0))
	    + "°</p>\n    <p class=\"summary \">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.currentWeather : depth0)) != null ? stack1.summary : stack1), depth0))
	    + "</p>\n\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <div class=\"card col-md-1\">\n    <h4 class=\"card-title\">"
	    ...
	    + "<br>\n        <hr>\n        Max Temp: "
	    + alias2(alias1((depth0 != null ? depth0.temperatureMax : depth0), depth0))
	    + "° <br>\n        Min Temp: "
	    + alias2(alias1((depth0 != null ? depth0.temperatureMin : depth0), depth0))
	    + "° <br>\n        <hr>\n        Max feels like: "
	    + alias2(alias1((depth0 != null ? depth0.apparentTemperatureMax : depth0), depth0))
	    + "° <br>\n        Min feels like: "
	    + alias2(alias1((depth0 != null ? depth0.apparentTemperatureMin : depth0), depth0))
	    + "° <br>\n      </p>\n    </div>\n  </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.forecast : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	    return "    <button type=\"button\" class=\"list-group-item multiple-results-list\">"
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.formatted_address : depth0), depth0))
	    + "</button>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.result : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	    return "    <button type=\"button\" class=\"list-group-item historical-multiple-results-list\">"
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.formatted_address : depth0), depth0))
	    + "</button>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0._id : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	  ...
	  return "    <tr>\n      <td>Current Forecast</td>\n      <td>"
	    ...
	    + "</td>\n      <td>Latitude: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.response : depth0)) != null ? stack1.latitude : stack1), depth0))
	    + "  Longitude: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.response : depth0)) != null ? stack1.longitude : stack1), depth0))
	    + "</td>\n    </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<tr>\n  <td>Historical Data</td>\n  <td>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.query : depth0)) != null ? stack1.createdAt : stack1), depth0))
	    + "</td>\n  <td>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.query : depth0)) != null ? stack1.location : stack1), depth0))
	    + "</td>\n  <td>Latitude: "
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.query : depth0)) != null ? stack1.response : stack1)) != null ? stack1.latitude : stack1), depth0))
	    + "  Longitude: "
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.query : depth0)) != null ? stack1.response : stack1)) != null ? stack1.longitude : stack1), depth0))
	    + "</td>\n</tr>\n";
	},"useData":true});
...
/***/ function(module, exports) {
	...
	function drawTempChart(response) {
	  ...
	  var formattedData = [['Date', 'Max Temp', 'Min Temp']];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(4);
	var authApi = __webpack_require__(138);
	var authUi = __webpack_require__(139);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["getFormFields"] = __webpack_require__(152);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["guid"] = __webpack_require__(154);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["getPosition"] = __webpack_require__(156);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["formatForecast"] = __webpack_require__(158);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
...
/***/ function(module, exports, __webpack_require__) {
	...
	function formatForecast(data) {
	  ...
	  for (var i = 0; i < data.daily.data.length; i++) {
	    ...
	    var dateModified = moment().add(i, 'days').format('LLLL');
	    var tokens = dateModified.split(' ').slice(0, 4);
	    ...
	    var date = new Date(data.daily.data[i].apparentTemperatureMaxTime * 1000);
	  }
	  return data;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["consolidateQueries"] = __webpack_require__(160);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
